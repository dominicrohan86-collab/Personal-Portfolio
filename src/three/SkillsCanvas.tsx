...
const Column = ({
  ...
  return (
    <Float
      ...
      floatIntensity={reducedMotion ? 0.2 : 0.6}
    >
      ...
      <Html
        distanceFactor={12}
        position={[column.position[0], height + 0.6, column.position[2]]}
      >
        <div className="rounded-md border border-accent/40 bg-slate-900/80 px-3 py-1 text-xs font-semibold text-accent shadow-glow">
          {column.label}
        </div>
      </Html>
    </Float>
...
export const SkillsCanvas = ({ categories }: SkillsCanvasProps) => {
  ...
  return (
    <div className="relative h-[420px] w-full">
      <Suspense
        fallback={
          <div className="flex h-full items-center justify-center text-sm text-accent/80">
      ...
      >
        <Canvas
          ...
          className="rounded-lg bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950"
        >
